...
export default function MenuDoppio2({
  ...
  const handleClientChange = (selectedOption) => {
    try {
      ...
      console.error("Errore durante il cambiamento del cliente:", error); // Manejo de errores
      setError("Si è verificato un errore durante il cambio del cliente."); // Mensaje de error
    }
  };
  ...
  const handleCommessaChange = (selectedOption) => {
    try {
      ...
      console.error("Errore durante il cambiamento della commessa:", error); // Manejo de errores
      setError("Si è verificato un errore durante il cambio della commessa."); // Mensaje de error
    }
  };
