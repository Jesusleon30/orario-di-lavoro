              ...
              >
                ...
                <td className="px-1 py-3">
                  <input
                    ...
                    value={entry.POSTO || ""}
                    onChange={(e) =>
                      handleInputChange(index, "LUOGO", e.target.value)
                    }
                    disabled={!isEditable}
                    className="w-[100px] text-gray-800 text-center bg-gray-200 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </td>
